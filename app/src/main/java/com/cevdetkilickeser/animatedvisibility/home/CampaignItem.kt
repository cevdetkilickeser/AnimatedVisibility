...
import com.cevdetkilickeser.animatedvisibility.model.Campaign
...
private fun CampaignItemPreview() {
    AnimatedVisibilityTheme {
        CampaignItem(
            campaign = Campaign(
                1,
                "Ev & İç Giyimde Şık Ürünler",
                "https://images.gardrops.com/campaign_uploads/images/2019/3/camp_img_5c8bbaeee4c70.jpg"
            )
        )
    }
}